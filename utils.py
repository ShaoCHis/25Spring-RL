...
def run_chief():
    try:
        ...
        #         output += line
        print(PROJECT_HOME)
        os.system(PYTHON_PATH + " " + os.path.join(PROJECT_HOME, "chief_workers", "chief_mqtt_main.py"))
...
def run_worker(worker_id):
    try:
        os.system(PYTHON_PATH + " " + os.path.join(PROJECT_HOME, "chief_workers", "worker_mqtt_main.py") + " {0}".format(worker_id))
